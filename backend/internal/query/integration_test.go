...
func TestIntegration_FullSQL(t *testing.T) { //nolint:gocyclo // This is a test function.
	tests := []struct {
		name      string
		input     string
...
func TestIntegration_QueryContext(t *testing.T) { //nolint:gocyclo // This is a test function.
	tests := []struct {
		name           string
		query          string
