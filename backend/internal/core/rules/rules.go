...
func (s *Service) GetRule(ctx context.Context, userID, ruleID string) (models.Rule, error) {
...
func (s *Service) DeleteRule(ctx context.Context, userID, ruleID string) error {
